...
public class FileJSONArray extends JSONArray {
	...
	public FileJSONArray( File f ) throws Exception {
		...
		if(f.exists()) {
			...
			try {
				this.addAll((JSONArray)JSONValue.parse( tr.toString() ));
			} catch (Exception e) {}
			tr.close();
		}
		f = null;
	...
	public FileJSONArray( String file_path, String file_name ) throws Exception {
